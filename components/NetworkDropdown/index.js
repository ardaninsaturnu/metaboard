  ...
  return (
    <Popover className="relative">
      <Popover.Button className="border border-solid border-[#8F9098ff] rounded-3xl flex items-center py-1 px-2 gap-2">
        ...
        <p className="text-[14px]">2 Networks</p>
        <ChevronDownIcon width={16}/>
      </Popover.Button>
        <Popover.Panel className="absolute z-10 min-w-[360px] w-[400px] bg-[#1E1F25ff] rounded-lg">
          <div className="flex justify-between w-full items-center p-4">
            <p className="text-sm font-semibold">Active Networks</p>
            <button className="rounded-3xl border border-[#8F9098ff] py-1 px-3 text-[10px] font-medium flex gap-1">
              {/*<MinusIcon width={16}/>*/}
              <CheckIcon width={16}/>Select All</button>
          </div>
          <div className="divide-y divide-[#8F9098ff]">
            ...
            <div className="p-4 flex gap-3">
              <PlusCircleIcon width={20}/> <span className="text-sm font-semibold">Enable in network settings</span>
            </div>
          </div>
        </Popover.Panel>
    </Popover>
